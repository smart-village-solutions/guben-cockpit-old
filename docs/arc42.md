...
| --- | --- |
| Frontend | `VITE_CONTENT_GATEWAY_URL`, `VITE_PUBLIC_CONTENT_SOURCE`, `VITE_BOOKING_URL`, `VITE_MASTERPORTAL_URL`, `VITE_TRANSLATE_URL`, `VITE_MATOMO_JS` |
| Gateway | `PORT`, `LOG_LEVEL`, `PUBLIC_BASE_URL`, `MASTERPORTAL_URL`, `CONTENT_SOURCE_MODE`, `DEFAULT_LANGUAGE`, `FALLBACK_LANGUAGE`, `POSTGREST_URL`, `POSTGREST_TIMEOUT_MS`, `POSTGREST_SCHEMA` |
